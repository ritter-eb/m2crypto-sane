...
class Cipher:
    ...
    def __init__(self, alg, key, iv, op, key_as_bytes=0, d='md5',
        ...
        # type: (AnyStr, AnyStr, bytes, object, int, AnyStr, AnyStr, int, int) -> None
    ...
    def update(self, data):
        # type: (Union[bytes, str, unicode]) -> bytes
...
class PKey:
    ...
    def __init__(self, pkey=None, _pyfree=0, md='sha1'):
        # type: (Optional[bytes], int, AnyStr) -> None
        if pkey is not None:
