...
from typing import Any, AnyStr, Callable  # noqa
...
class RSA:
    ...
    def save_key_bio(self, bio, cipher='aes_128_cbc',
        ...
        # type: (BIO.BIO, AnyStr, Callable) -> int
        """
    ...
    def verify_rsassa_pss(self, data, signature, algo='sha1', salt_length=20):
        # type: (bytes, bytes, AnyStr, int) -> int
        """
...
def new_pub_key(e_n):
    # type: (tuple[bytes, bytes]) -> RSA.RSA_pub
    """
