0.25.0 - unreleased
-------------------
- Use swig option '-builtin' conditionally. This option is only available in
  swing versions above 2.0.3 (closes `#140`_).
...
.. _`#140`:
    https://gitlab.com/m2crypto/m2crypto/issues/140
